...
// https://pkg.go.dev/github.com/coniks-sys/coniks-go@v0.0.0-20180722014011-11acf4819b71/crypto/internal/ed25519/edwards25519
...
func Q() *big.Int {
	...
	//println("Q=", new(big.Int).SetBytes(qBytesArray[:]).String())
